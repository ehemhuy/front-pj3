    ...
    return (
      <div>
        <div
          ...
          style={{
            backgroundImage:
              "url(https://themegoods-cdn-pzbycso8wng.stackpathdns.com/grandspa/demo/wp-content/uploads/2017/06/f3d7c86de36c594617f239bf8e83ad47.jpg)",
          }}
        >
        ...
        <Container>
          ...
          <h3 className="commitment_content">
            “Breathe in peace, breathe out stress. Relaxing can bring relief to
            much of what ails you. In our stressful and often negative world,
            your decision to make relaxing a priority will help you navigate,
            handle, and minimize stress”
          </h3>
          <div
            style={{
              textAlign: "center",
