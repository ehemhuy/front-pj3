...
export default class Register extends Component {
  ...
  Submit = async (e) => {
    ...
    if (
      (errNew.confirmPassword == "" || errNew.confirmPassword == null) &&
  ...
  render() {
    {
      if (this.state.isSingedUp) return <Redirect to="/login" />;
    }
    return (
        ...
        >
          ...
          <form>
            <div className="form-group">
              <label htmlFor="firstName" className="col-sm form-control-label">
                First Name
              </label>
            ...
            <div className="form-group">
              <label htmlFor="lastName" className="col-sm form-control-label">
                Last Name
              </label>
              <div className="col-sm">
                <input
            ...
            <div class="form-group">
              <label for="address" class="col-sm form-control-label">
                Address
              </label>
              <div class="col-sm">
                <input
              ...
              <p class="form-text  text-danger login-err" id="invalid-address">
                {this.state.err?.adress}
              </p>
            </div>

            <div className="form-group">
              <label htmlFor="phone" className="col-sm form-control-label">
                Phone
              </label>
              <div className="col-sm">
                <input
            ...
            <div className="form-group">
              <label
                ...
                className="col-sm form-control-label"
              >
                Confirm Password
              </label>
              <div className="col-sm">
            ...
            <br />
            <Link style={{ paddingLeft: "15px" }} to="/login">
              {" "}
