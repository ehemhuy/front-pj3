      ...
      <div className="contact">
        ...
        <div className="text-contact">
          ...
          <h3 style={{textAlign: 'center'}}>
            “chất lượng sản phẩm, dịch vụ cung cấp là tốt nhất - chế độ bảo hành, bảo trì và chăm sóc khách hàng tốt nhất -  chất lượng sản phẩm và dịch vụ tốt nhất vượt ngoài sự mong đợi từ khách hàng”
          </h3>
        </div>

        <div className="contact-map">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4461.575339246853!2d105.84913271071304!3d21.003385664182236!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ac74f21ad2c7%3A0x8e1a68269eb14672!2zMjAgTMOqIFRoYW5oIE5naOG7iywgQ-G6p3UgROG7gW4sIEhhaSBCw6AgVHLGsG5nLCBIw6AgTuG7mWk!5e0!3m2!1svi!2s!4v1595385580375!5m2!1svi!2s"
            height="600"
            frameborder="0"
          ...
          <div className="col-sm-6 box1">
            <ul>
              <li>
                ...
                <p className="contact-box-p-1">
                  20 Lê Thanh Nghị - Hai Bà Trưng - Hà Nội
                </p>
              </li>
              <li>
                <h2 className="contact-box-h2-2">Thông tin chiết</h2>
                <p className="contact-box-p-2">
              ...
              <li>
                <p className="contact-box-p-3">Call 848573699</p>
              </li>

              <li>
                <h2 className="contact-box-h2-4">Kết nối với chúng tôi</h2>
                <div className="icons">
